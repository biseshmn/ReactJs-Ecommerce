...
exports.postOrder = async (req, res) => {
    ...
    const TotalPrice = totalAmount.reduce((a, c) => a + c, 0)
...
//order list of particular user
exports.userOrders = async (req, res) => {
    const userOrderLists = await Order.find({ user: req.params.userid })
        .populate({
            path: 'orderItems',
            populate: {
                path: 'product',
